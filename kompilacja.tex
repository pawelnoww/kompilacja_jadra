...
Podczas kompilacji jądra obiema metodami nie napotkałem większych trudności. Jedyny błąd przytrafił się podczas drugiej metody i wynikał tylko z mojego niedopatrzenia, a wystąpił podczas kopiowania plików - podałem błędną nazwę. Oba rozwiązania wydają się dość podobne, mają bardzo dużą część wspólną. Bardzo pomocna okazała się instrukcja zawierająca konkretne przykłady komend w przypadku metody drugiej.
